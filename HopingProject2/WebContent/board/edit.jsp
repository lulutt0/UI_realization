...
<body>
	...
	<div class="container-header">
		...
		<ul class="navbar__menu" id="navbar__menu__a">
			 <li><a href="../job/company/CompanyList.jsp"><span>채용정보</span></a></li>
                <li><a href="../job/companyCompanySelect.jsp"><span>맞춤설정</span></a></li>
	...
	<div class="board_wrap">
		...
		<div class="board_write_wrap">
			<div class="board_write">
				...
				<div class="info">
					<dl>
						<dt>글쓴이</dt>
						<dd>
							<input type="text" placeholder="글쓴이 입력" value="김이">
						</dd>
					</dl>
					<dl>
						<dt>비밀번호</dt>
			...
			<div class="bt_wrap">
				<a href="view.jsp" class="on">수정</a> <a href="view.jsp">취소</a>
			</div>
		</div>
	</div>
	<!-- footer -->
